package Dist::Joseki::Command::test;
use strict;
use warnings;
use Dist::Joseki;
our $VERSION = '0.20';
...
Dist::Joseki::Command::test - 'test' command for Dist::Joseki::Cmd

=head1 SYNOPSIS

    Dist::Joseki::Command::test->new;
...
Dist::Joseki::Command::test inherits from
